...
static void DrawChoices_ListWrapping(int selection, int y);
...
} static const sItemFunctionsCustom[MENUITEM_CUSTOM_COUNT] =
{
    ...
    [MENUITEM_CUSTOM_LIST_WRAPPING] = {DrawChoices_ListWrapping, ProcessInput_Options_Two},
...
static const u8 sText_ListWrapping[] = _("LIST WRAPPING");
...
static const u8 *const sOptionMenuItemsNamesCustom[MENUITEM_CUSTOM_COUNT] =
{
    ...
    [MENUITEM_CUSTOM_LIST_WRAPPING] = sText_ListWrapping,
...
static bool8 CheckConditions(int selection)
{
    ...
    case MENU_CUSTOM:
        ...
        case MENUITEM_CUSTOM_LIST_WRAPPING: return TRUE;
...
static const u8 sText_Desc_ListWrappingOn[] = _("When at the bottom of a list and pressing down\nyou'll wrap back to the top");
static const u8 sText_Desc_ListWrappingOff[] = _("When at the bottom of a list and pressing down\nnothing will happen");
static const u8 *const sOptionMenuItemDescriptionsCustom[MENUITEM_CUSTOM_COUNT][2] =
{
    ...
    [MENUITEM_CUSTOM_LIST_WRAPPING] = {sText_Desc_ListWrappingOn, sText_Desc_ListWrappingOff},
...
static const u8 *const sOptionMenuItemDescriptionsDisabledCustom[MENUITEM_CUSTOM_COUNT] =
{
    ...
    [MENUITEM_CUSTOM_LIST_WRAPPING] = sText_Empty,
...
void CB2_InitOptionMenu(void)
{
    ...
    case 6:
        ...
        sOptions->sel_custom[MENUITEM_CUSTOM_LIST_WRAPPING] = gSaveBlock2Ptr->optionsDisableListWrapping;
...
static void Task_OptionMenuSave(u8 taskId)
{
    ...
    gSaveBlock2Ptr->optionsDisableListWrapping = sOptions->sel_custom[MENUITEM_CUSTOM_LIST_WRAPPING];
...
static void DrawChoices_ListWrapping(int selection, int y)
{
    bool8 active = CheckConditions(MENUITEM_CUSTOM_LIST_WRAPPING);
    u8 styles[2] = {0};
    styles[selection] = 1;
