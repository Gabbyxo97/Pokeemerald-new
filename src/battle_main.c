...
void SetTypeBeforeUsingMove(u16 move, u8 battlerAtk)
{
    ...
    {
        gBattleStruct->dynamicMoveType = GetHiddenPowerType(
            gBattleMons[battlerAtk].hpIV,
            gBattleMons[battlerAtk].attackIV,
            gBattleMons[battlerAtk].defenseIV,
            gBattleMons[battlerAtk].speedIV,
            gBattleMons[battlerAtk].spAttackIV,
            gBattleMons[battlerAtk].spDefenseIV
        );
    }
